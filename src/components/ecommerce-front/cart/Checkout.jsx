...
import CustomerWelcome from "@/components/ecommerce-front/widgets/CustomerWelcome";
                        ...
                        <div className="mt-4 mx-2  ">
                            <form className="space-y-4 md:space-y-0 md:grid md:grid-cols-2 md:gap-6">
                                <div className="flex flex-col">
                                    ...
                                    <input value={shippingAddress.first_name} id="first-name" name="first-name" type="text" className="mt-1 p-2 border border-gray-300 rounded-md" required/>
                                </div>

                                <div className="flex flex-col">
                                    <label htmlFor="last-name" className="text-sm font-medium text-gray-700">Last Name</label>
                                    <input value={shippingAddress.last_name} id="last-name" name="last-name" type="text" className="mt-1 p-2 border border-gray-300 rounded-md" required/>
                                </div>

                                <div className="flex flex-col">
                                    <label htmlFor="email" className="text-sm font-medium text-gray-700">Email</label>
                                    <input value={shippingAddress.email} id="email" name="email" type="email" className="mt-1 p-2 border border-gray-300 rounded-md" required/>
                                </div>

                                <div className="flex flex-col">
                                    <label htmlFor="phone" className="text-sm font-medium text-gray-700">Phone Number</label>
                                    <input value={shippingAddress.phone} id="phone" name="phone" type="tel" className="mt-1 p-2 border border-gray-300 rounded-md" required/>
                                </div>

                                <div className="flex flex-col md:col-span-2">
                                    <label htmlFor="address" className="text-sm font-medium text-gray-700">Address</label>
                                    <textarea value={shippingAddress.address} id="address" name="address" rows="4" className="mt-1 p-2 border border-gray-300 rounded-md" required></textarea>
                                </div>
                            ...
                            <div className="mt-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <label className="flex items-center">
                                        <input type="radio" name="payment" value="cash-on-delivery" className="mr-2"/> Cash on delivery
                                    </label>
                                    <label className="flex items-center">
                                        <input type="radio" name="payment" value="pay-now" className="mr-2"/> Pay Now
                                    </label>
                                </div>
