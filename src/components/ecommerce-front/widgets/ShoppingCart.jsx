    ...
    return (
        <div>
            ...
            >
                ...
                <span className="ml-2 hidden sm:block text-sm">Shopping Cart</span>
                <div className="hidden lg:block absolute right-0 top-full mt-2">
                    {showCart && (
                        <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg p-4 z-[9999] border border-gray-200">
