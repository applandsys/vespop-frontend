            ...
            <div className="relative flex" ref={dropdownRef}>
                {!customer ? (
                    <div className="flex justify-center items-center">
                        ...
                        >
                            <span className="mr-2 hidden sm:block text-sm"> Sign In </span>
                        </Link>
                        ...
                        <Link
                            ...
                            className="hover:text-blue-600 flex items-center transition-colors"
                        >
                            <span className="ml-2 hidden sm:block text-sm"> Create an Account</span>
                        </Link>
                    </div>
                ) : (
                    <>
                        ...
                        >
                            ...
                            <span className="ml-2 hidden sm:block text-sm">Account</span>
                        </div>

                        {isOpen && (
                            <div className="absolute right-0 top-full mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-[9999] py-1">
                                <div
