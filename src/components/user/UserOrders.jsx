                        ...
                        <tr key={order.id} className="hover:bg-gray-50">
                          ...
                          >
                            ...
                            <td className="px-6 py-4 text-right">
                                <Link href={`/user/orders/detail/${order.id}`} className="text-blue-600 hover:text-blue-800 text-sm font-medium bg:green-300 border-gray-300 rounded-md mx-2 p-2">
                                    View Details
                                </Link>
                                <Link href={`/user/orders/tracking/${order.id}`} className="text-blue-600 hover:text-blue-800 text-sm font-medium bg:yellow-300 border-gray-300 rounded-md mx-2 p-2">
                                    Track
                                </Link>
                            </td>
                        </tr>
